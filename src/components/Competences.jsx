...
const categories = [
  {
    ...
    color: '#818cf8',
    tools: [
      { name: 'Windows Server', desc: 'Administration et gestion de serveurs Windows Server 2022/2025', color: '#0078D4', logo: '/logos/windows.svg', url: 'https://www.microsoft.com/fr-fr/windows-server' },
      { name: 'Windows 10/11', desc: 'Déploiement, configuration et maintenance des postes clients', color: '#0078D4', logo: '/logos/windows.svg', url: 'https://www.microsoft.com/fr-fr/windows' },
      { name: 'Linux Debian', desc: 'Installation et administration de serveurs Linux Debian 12', color: '#A81D33', logo: '/logos/debian.svg', url: 'https://www.debian.org/' },
      { name: 'GLPI', desc: 'Gestion de parc informatique et ticketing helpdesk', color: '#7C3AED', logo: '/logos/glpi.svg', url: 'https://glpi-project.org/' },
  ...
  },
  {
    ...
    color: '#22d3ee',
    tools: [
      { name: 'Proxmox', desc: 'Création et gestion de machines virtuelles', color: '#E57000', logo: '/logos/proxmox.svg', url: 'https://www.proxmox.com/' },
      ...
      { name: 'pfSense', desc: 'Configuration de pare-feu et routage réseau', color: '#212121', logo: '/logos/pfsense.svg', url: 'https://www.pfsense.org/' },
      { name: 'VMware', desc: 'Création et gestion de machines virtuelles', color: '#607078', logo: '/logos/vmware.svg', url: 'https://www.vmware.com/' },
    ],
  },
  {
    ...
    color: '#fb7185',
    tools: [
      { name: 'Wireshark', desc: 'Analyse du trafic réseau et détection d\'anomalies', color: '#1679A7', logo: '/logos/wireshark.svg', url: 'https://www.wireshark.org/' },
      { name: 'Kali Linux', desc: 'Application des bonnes pratiques de cybersécurité et tests de pénétration', color: '#557C94', logo: '/logos/kalilinux.svg', url: 'https://www.kali.org/' },
      { name: 'Nessus', desc: 'Audit de vulnérabilités et sécurisation des infrastructures', color: '#00B8D9', logo: '/logos/nessus.svg', url: 'https://www.tenable.com/products/nessus' },
      { name: 'OpenVPN', desc: 'Mise en place de tunnels VPN et sécurisation des échanges', color: '#EA7E20', logo: '/logos/openvpn.svg', url: 'https://openvpn.net/' },
  ...
  },
  {
    ...
    color: '#34d399',
    tools: [
      { name: 'Nagios', desc: 'Supervision et maintenance des infrastructures informatiques', color: '#3EB049', logo: '/logos/nagios.svg', url: 'https://www.nagios.org/' },
