...
const syntheseData = [
  {
    ...
    color: '#22d3ee',
    competences: [
      { code: 'B1.1', label: 'Gérer le patrimoine informatique', projets: ['GLPI', 'Nagios', 'Calculatrice Web', 'Stage B&A Conseil'] },
      { code: 'B1.2', label: 'Répondre aux incidents et demandes', projets: ['GLPI', 'Nagios', 'Stage B&A Conseil', 'Stage Les Réparateurs'] },
      { code: 'B1.3', label: 'Développer la présence en ligne', projets: ['Calculatrice Web', 'Portfolio Web'] },
      { code: 'B1.4', label: 'Travailler en mode projet', projets: ['Tous les projets'] },
      { code: 'B1.5', label: 'Mettre à disposition un service IT', projets: ['GLPI', 'Nagios', 'VOIP Cisco', 'AD Entreprise'] },
      { code: 'B1.6', label: 'Organiser son développement professionnel', projets: ['Veille Phishing', 'Certifications ANSSI & Cisco'] },
    ],
  },
  {
    bloc: 'B2',
    ...
    color: '#a855f3',
    competences: [
      { code: 'B2.1', label: 'Concevoir une solution d\'infrastructure', projets: ['VLAN', 'Active Directory & DNS', 'VOIP Cisco'] },
      { code: 'B2.2', label: 'Installer, tester et déployer', projets: ['AD & DNS', 'VLAN', 'GPO', 'Nagios', 'VOIP', 'GLPI', 'AD Entreprise'] },
      { code: 'B2.3', label: 'Exploiter, dépanner et superviser', projets: ['Nagios', 'VLAN', 'GPO', 'VOIP', 'Wireshark', 'AD Entreprise'] },
    ],
  },
  {
    bloc: 'B3',
    ...
    color: '#fb7185',
    competences: [
      { code: 'B3.1', label: 'Protéger les données personnelles', projets: ['Veille Phishing', 'GPO'] },
      { code: 'B3.2', label: 'Préserver l\'identité numérique', projets: ['AD & DNS', 'GPO', 'AD Entreprise'] },
      { code: 'B3.3', label: 'Sécuriser les équipements et usages', projets: ['GPO', 'AD & DNS', 'AD Entreprise', 'Stage B&A Conseil'] },
      { code: 'B3.4', label: 'Garantir disponibilité et intégrité', projets: ['Nagios', 'GPO', 'Wireshark', 'AD Entreprise'] },
      { code: 'B3.5', label: 'Assurer la cybersécurité réseau', projets: ['Wireshark', 'VLAN', 'Veille Phishing'] },
    ],
  },
]
