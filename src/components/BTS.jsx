...
const epreuves = [
  ...
  },
  {
    ...
    monProjet: 'Infrastructure Active Directory + Segmentation VLAN + GPO + Supervision Nagios + VOIP Cisco + Analyse Wireshark — réalisés en environnement de laboratoire.',
    color: '#a855f3',
    docs: [
      {
...
const syntheseData = [
  {
    ...
    color: '#22d3ee',
    competences: [
      { code: 'B1.1', label: 'Gérer le patrimoine informatique', projets: ['Calculatrice Web', 'Nagios'] },
      { code: 'B1.2', label: 'Répondre aux incidents et demandes', projets: ['Nagios', 'Stage B&A Conseil'] },
  ...
  },
  {
    ...
    competences: [
      ...
      { code: 'B2.2', label: 'Installer, tester et déployer', projets: ['Active Directory & DNS', 'VLAN', 'GPO', 'Nagios', 'VOIP Cisco'] },
      { code: 'B2.3', label: 'Exploiter, dépanner et superviser', projets: ['Nagios', 'VLAN', 'GPO', 'VOIP Cisco', 'Wireshark'] },
    ],
  },
  {
    bloc: 'B3',
    ...
    competences: [
      ...
      { code: 'B3.2', label: 'Préserver l\'identité numérique', projets: ['Active Directory & DNS', 'GPO'] },
      { code: 'B3.3', label: 'Sécuriser les équipements et usages', projets: ['GPO', 'Active Directory & DNS'] },
      { code: 'B3.4', label: 'Garantir disponibilité et intégrité', projets: ['Nagios', 'GPO', 'Wireshark'] },
