...
const projets = [
  ...
  },
  {
    ...
    fullDesc: "Mise en place d'un tunnel VPN SSL/TLS avec OpenVPN sur Debian 12 : création d'une PKI (CA, certificats serveur/clients), configuration du routage, règles iptables NAT/FORWARD et journalisation des connexions.",
    technologies: ['OpenVPN', 'PKI', 'iptables', 'Debian', 'SSL/TLS'],
    docPdf: null,
  },
  {
    id: 8,
    ...
    fullDesc: "Déploiement de Nagios Core sur Debian pour la supervision d'une infrastructure réseau : définition des hôtes et services, plugins NRPE pour métriques Linux/Windows, SNMP pour équipements réseau et configuration des alertes email.",
    technologies: ['Nagios', 'NRPE', 'SNMP', 'Debian', 'Monitoring'],
    docPdf: null,
  },
]
