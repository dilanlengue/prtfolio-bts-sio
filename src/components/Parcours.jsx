...
const stages = [
  {
    ...
    items: [
      ...
      'Déploiement et configuration de postes Windows 10/11 en environnement professionnel',
      'Déploiement de GLPI 10 + FusionInventory pour la gestion de parc informatique',
      'Inventaire automatisé de 40+ machines via l\'agent FusionInventory',
      'Configuration et gestion de tickets d\'incidents selon le processus ITIL',
      'Configuration de smartphones professionnels et solutions MDM (Mobile Device Management)',
      'Activation et configuration de cartes eSIM pour les collaborateurs (QR code, codes PIN/PUK, paramétrage Android/iOS)',
      'Rédaction de procédures techniques pour la documentation interne',
      'Assistance utilisateurs on-site et à distance (TeamViewer, bureau à distance)',
    ],
  },
  {
    date: 'Mai — Juil 2025',
    ...
    place: 'Montreuil',
    pills: ['Support N1/N2', 'Réseaux', 'Réparation', 'macOS', 'Windows', 'Linux'],
    items: [
      'Diagnostic matériel et logiciel de postes Mac et PC (pannes carte mère, écran, stockage)',
      'Réinstallation et configuration de systèmes d\'exploitation (Windows, macOS, Linux)',
      'Récupération de données sur disques durs défaillants et SSD endommagés',
      'Configuration et dépannage de réseaux locaux (Wi-Fi, Ethernet, routeurs)',
      'Nettoyage en profondeur et maintenance préventive (pâte thermique, ventilation)',
      'Accueil client, diagnostic initial et devis de réparation',
      'Reconditionnement de matériel informatique pour revente',
    ],
  },
]
